...
public class MainFrame {
    ...
    public void createFrame() {
        ...
        JLabel tenChip = new JLabel(new ImageIcon(new ImageIcon(getClass().getResource("resources/images/Chips/TEN.png")).getImage().getScaledInstance(70, 70, Image.SCALE_DEFAULT)));
        ...
        JLabel fiftyChip = new JLabel(new ImageIcon(new ImageIcon(getClass().getResource("resources/images/Chips/FIFTY.png")).getImage().getScaledInstance(70, 70, Image.SCALE_DEFAULT)));
        ...
        JLabel hundredChip = new JLabel(new ImageIcon(new ImageIcon(getClass().getResource("resources/images/Chips/HUNDRED.png")).getImage().getScaledInstance(70, 70, Image.SCALE_DEFAULT)));
        ...
        JLabel fiveHundredChip = new JLabel(new ImageIcon(new ImageIcon(getClass().getResource("resources/images/Chips/FIVE_HUNDRED.png")).getImage().getScaledInstance(70, 70, Image.SCALE_DEFAULT)));
        ...
        JLabel thousandChip = new JLabel(new ImageIcon(new ImageIcon(getClass().getResource("resources/images/Chips/THOUSAND.png")).getImage().getScaledInstance(70, 70, Image.SCALE_DEFAULT)));
    ...
    public void addPlayerCard(Card card) {
        ...
        try {
            new MP3Player(Paths.get(getClass().getResource("resources/audio/DealCard.mp3").toURI()).toFile()).play();
        } catch (URISyntaxException e) {
            e.printStackTrace();
        }
        URL fileURL = getClass().getResource("resources/images/" + card.getSuit().toString()+"/"+card.getRank().toString()+".png");
        JLabel cardLabel = new JLabel(new ImageIcon(fileURL));
    ...
    public void addDealerCard(Card card) {
        ...
        if (card.isFaceUp) {
            ...
            URL fileURL = getClass().getResource("resources/images/CardFaceDown.png");
            JLabel cardLabel = new JLabel(new ImageIcon(fileURL));
            dealerHand.add(cardLabel);
        }
        frame.setVisible(true);
    ...
    public void playMusic() {
        try {
            new MP3Player(Paths.get(getClass().getResource("resources/audio/CasinoMusic.mp3").toURI()).toFile()).play();
        } catch (URISyntaxException e) {
            e.printStackTrace();
        }
    }
